...
public class LocalFormatSampleIndex {
  ...
  public static final Sample[] SAMPLES = new Sample[] {
      new Sample("demo-adts-48000.aac", 2364196011L),
      ...
      new Sample("demo-oggopus-48000.ogg", 3781942969L),
      new Sample("demo-oggvorbis-44100.ogg", 3562794104L),
      new Sample("demo-oggvorbis-48000.ogg", 863664551L),
      new Sample("demo-tsadts-48000.ts", 2364196011L),
  ...
  public static class Sample {
    ...
    public Sample(String filename, long expectedCrc) {
