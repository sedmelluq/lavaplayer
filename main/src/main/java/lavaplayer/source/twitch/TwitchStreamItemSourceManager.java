 ...
 */
public class TwitchStreamItemSourceManager implements ItemSourceManager, HttpConfigurable {
     ...
     * Create an instance.
     */
    public TwitchStreamItemSourceManager() {
     ...
     */
    public TwitchStreamItemSourceManager(String clientId) {
