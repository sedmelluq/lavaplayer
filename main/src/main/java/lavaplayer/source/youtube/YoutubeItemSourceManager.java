...
import static lavaplayer.tools.FriendlyException.Severity.*;

/**
 * Audio source manager that implements finding Youtube videos or playlists based on an URL or ID.
 */
public class YoutubeItemSourceManager implements ItemSourceManager, HttpConfigurable {
    private static final Logger log = LoggerFactory.getLogger(YoutubeItemSourceManager.class);
     ...
     */
    public YoutubeItemSourceManager() {
        this(true);
    }
     ...
     */
    public YoutubeItemSourceManager(boolean allowSearch) {
        this(
            allowSearch,
        ...
        public AudioItem playlist(String playlistId, String selectedVideoId) {
            ...
            try (HttpInterface httpInterface = getHttpInterface()) {
                return playlistLoader.load(httpInterface, playlistId, selectedVideoId,
                    YoutubeItemSourceManager.this::buildTrackFromInfo);
            } catch (Exception e) {
