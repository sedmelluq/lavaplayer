...
object YoutubeConstants {
    ...
    internal const val BASE_PAYLOAD = "{\"context\":{\"client\":{\"clientName\":\"$CLIENT_NAME\",\"clientVersion\":\"$CLIENT_VERSION\"}},"
    internal const val PLAYER_URL = "$BASE_URL/player?key=$INNERTUBE_API_KEY"
    internal const val PLAYER_PAYLOAD = "$BASE_PAYLOAD\"racyCheckOk\":true,\"contentCheckOk\":true,\"videoId\":\"%s\",\"playbackContext\":{\"contentPlaybackContext\":{\"signatureTimestamp\":%s}}}"
    internal const val VERIFY_AGE_URL = "$BASE_URL/verify_age?key=$INNERTUBE_API_KEY"
    internal const val VERIFY_AGE_PAYLOAD = "$BASE_PAYLOAD\"nextEndpoint\":{\"urlEndpoint\":{\"url\":\"%s\"}},\"setControvercy\":true}"
    ...
    internal const val MUSIC_BASE_PAYLOAD = "{\"context\":{\"client\":{\"clientName\":\"$MUSIC_CLIENT_NAME\",\"clientVersion\":\"$MUSIC_CLIENT_VERSION\"}},"
    internal const val MUSIC_SEARCH_URL = "$MUSIC_BASE_URL/search?key=$MUSIC_INNERTUBE_API_KEY"
    internal const val MUSIC_SEARCH_PAYLOAD = "$MUSIC_BASE_PAYLOAD\"query\":\"%s\",\"params\":\"Eg-KAQwIARAAGAAgACgAMABqChADEAQQCRAFEAo=\"}"
