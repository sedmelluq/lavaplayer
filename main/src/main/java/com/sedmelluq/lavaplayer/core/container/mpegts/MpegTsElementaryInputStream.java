...
import com.sedmelluq.lavaplayer.core.tools.io.BitBufferReader;
 ...
 */
public class MpegTsElementaryInputStream extends InputStream implements AudioTrackInfoProvider {
  ...
  public void provideTrackInfo(AudioTrackInfoBuilder builder) {
    builder
        .with(coreTitle(serviceName))
        .with(coreAuthor(serviceProviderName));
  }
