...
public class FinalPcmAudioFilter implements UniversalPcmAudioFilter {
   ...
   */
  public FinalPcmAudioFilter(AudioPlaybackContext context, Collection<AudioPostProcessor> postProcessors) {
    this.format = context.getConfiguration().getOutputFormat();
