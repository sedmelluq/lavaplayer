 ...
 */
public class WavTrackProvider implements Closeable {
   ...
   */
  public WavTrackProvider(AudioPlaybackContext context, SeekableInputStream inputStream, WavFileInfo info) {
