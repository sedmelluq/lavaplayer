...
import com.sedmelluq.lavaplayer.core.tools.io.ResettableBoundedInputStream;
...
public class AdtsStreamProvider implements Closeable {
   ...
   */
  public AdtsStreamProvider(InputStream inputStream, AudioPlaybackContext context) {
