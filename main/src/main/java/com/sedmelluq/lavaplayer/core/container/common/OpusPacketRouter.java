package com.sedmelluq.lavaplayer.core.container.common;

import com.sedmelluq.lavaplayer.core.player.filter.AudioPipeline;
import com.sedmelluq.lavaplayer.core.player.filter.PcmFormat;
import com.sedmelluq.discord.lavaplayer.natives.opus.OpusDecoder;
import com.sedmelluq.lavaplayer.core.format.OpusAudioDataFormat;
import com.sedmelluq.lavaplayer.core.player.filter.AudioPipelineFactory;
import com.sedmelluq.lavaplayer.core.player.filter.volume.AudioFrameVolumeChanger;
...
public class OpusPacketRouter {
   ...
   */
  public OpusPacketRouter(AudioPlaybackContext context, int inputFrequency, int inputChannels) {
    ...
    offeredFrame.setFormat(context.getConfiguration().getOutputFormat());
  }
  ...
  private void passThrough(ByteBuffer buffer) throws InterruptedException {
    if (requestedTimecode < currentTimecode) {
      offeredFrame.setTimecode(currentTimecode - currentFrameDuration);
