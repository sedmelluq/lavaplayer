...
import com.sedmelluq.lavaplayer.core.container.matroska.format.MatroskaFileTrack.AudioDetails;
...
public class MatroskaVorbisTrackConsumer implements MatroskaTrackConsumer {
   ...
   */
  public MatroskaVorbisTrackConsumer(AudioPlaybackContext context, MatroskaFileTrack track) {
