package com.sedmelluq.lavaplayer.core.player.marker;

import java.util.concurrent.atomic.AtomicReference;

import static com.sedmelluq.lavaplayer.core.player.marker.TrackMarkerHandler.MarkerState.BYPASSED;
import static com.sedmelluq.lavaplayer.core.player.marker.TrackMarkerHandler.MarkerState.LATE;
import static com.sedmelluq.lavaplayer.core.player.marker.TrackMarkerHandler.MarkerState.OVERWRITTEN;
import static com.sedmelluq.lavaplayer.core.player.marker.TrackMarkerHandler.MarkerState.REACHED;
import static com.sedmelluq.lavaplayer.core.player.marker.TrackMarkerHandler.MarkerState.REMOVED;
